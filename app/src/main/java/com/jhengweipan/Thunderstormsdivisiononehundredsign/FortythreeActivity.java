...
public class FortythreeActivity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第四三籤");
		text2.setText("【 中吉。戊丙】");
		text4.setText("一紙官書火急催");
		text5.setText("扁舟速下浪如雷");
		text6.setText("雖然目下多驚險");
		text7.setText("保汝平安去復回");
		text8.setText("(一)玄德公黃鶴樓赴宴");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "一紙官書火急催扁舟速下浪如雷雖然目下多驚險保汝平安去復回"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20043%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="功名遂。子嗣歡。訟病險。終必安。 失物在。行人還。婚宜遠。利不難。";//聖意一
		str3="功名遂。好求官。訟病險。終必安。 失物在。行人還。婚宜遠。利不難。";//聖意二
		str4="";//東坡解
		str5="官書火急。激聒之兆。目下雖驚。終無紛擾。 有神陰扶。收功談笑。來往平安。吉星高照。";//東坡解一
		str6="官書火急。激聒之兆。目下雖驚。終無紛擾。 有神陰扶。收功談笑。來往平安。吉星拱照。";//東坡解二
		str7="先驚未是驚。後喜方為喜。 若問謀事多。連綿無定止。";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤先凶後吉者。謀望終有好處。病者虛險。自然解散。大事成。求官遂。問訟好。婚姻不難。失物還。行人至。凡事大吉。";//解曰
		str11="火急催者。王有激聒。是非占者。目下驚恐。到後無事。新病易廖。久病難保。凶事化吉。大事變小。求名利者。有疾病是非之累。方應其占。而得選舉。否則難遂。回字或作來字。";//釋義
		str12="一生會試。值以人命搆訟所阻。占得此後。司憲見而奇之。許令應試。遂中。春榜全詩皆應。此占。凡問病無有不廖者。惟(清)道光(年)間。一人患中瘋症。占此後。雖平安。但病根終不能除耳。是去復回。句之應也。";//占驗
		str13="(一)玄德公黃鶴樓赴宴\n漢。劉備。字玄德。獻帝時。群雄割據。曹操挾天子令諸侯。玄德未得四川。借與荊州。托足周瑜。計請赴宴。設伏挾討。幸孔明授趙雲密計。計得免於難。此係俗傳。攷史。赤壁合兵拒操時。瑜計請玄德。設伏欲害。因見關公在場。不敢動手。";//故事	
	}
	@Override
