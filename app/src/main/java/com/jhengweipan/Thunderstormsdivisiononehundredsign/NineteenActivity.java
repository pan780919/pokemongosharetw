...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第十九籤");
		text2.setText("【 上吉。乙壬】");
		text4.setText("嗟子從來未得時");
		text5.setText("今年星運頗相宜");
		text6.setText("營求動作都如意");
		text7.setText("和合婚姻誕貴兒");
		text8.setText("(一)劉智遠得岳氏");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "嗟子從來未得時今年星運頗相宜營求動作都如意和合婚姻誕貴兒"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20019%E7%B1%A4.jpg" ;//圖
		
		str1="作事吉。名利遂。婚姻成。訟得理。 孕生貴。行人至。病易安。皆吉利。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="久困沉埋。時運今泰。作事有成。名利俱快。 更無阻滯。宜為買賣。士人占之。前程遠大。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="時來時去有其時。但要平心任所為。 自此謀為皆遂意。孕生貴子時宗枝。";//碧仙註一
		str9="時來時去本參差。時運亨通任所為。財祿科名皆遂意。婚姻嗣息總相宜。"; //碧仙註二
		str10="此籤不問貴賤。皆有和合之象。謀為各事。從今以後可成就也。";//解曰
		str11="作客經紀吉。營與人索取吉。求要為此事吉。動力為此事吉。(吉本作曰) 作凡事。交秋來新運。自然無阻。無子者得子。無官者得官。始雖頗相宜。終則滔滔順也。從來未得時。有兩義。占者在得意之日。反不應。此在失意之日。許應此。又當推年命歲運相合。詩意為美";//釋義
		str12="一生。占秋闈。得此。下第。蓋頗宜者。猶未甚宜也。試畢。以歲者。准貢是小事吉也。又先兄。諱晴光。己亥科試。占此籤。自解曰。誕貴兒。是生子。已完果入泮。為縣學生員。及咸豊登丑元旦。又占得此籤。復自解曰。誕貴兒。是此生已完矣。果於是年三月卒。又余門人王景星。亦占此籤。入泮。蓋童生占之則吉也。凡占科。各逢未年。必捷。應未便得時也。內史王的識。";//占驗
		str13="(一)劉智遠得岳氏\n劉智遠(知遠)。沙陶(沙陀)人。初為節度使。岳彥真軍校時。彥真奇其相貌。以女妻焉。後仕晉。為邠州太原節度。契丹滅晉。中原無主。智遠乃即帝位。改國曰后漢。仍稱天福而不改元。";//故事	
	}
	@Override
