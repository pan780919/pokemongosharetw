...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第九籤");
		text2.setText("【大吉。甲壬】");
		text4.setText("望渠消息向長安");
		text5.setText("常把菱花仔細看");
		text6.setText("見說文書將入境");
		text7.setText("今朝喜色上眉端");
		text8.setText("(一)宋太祖陳橋即位");
		text9.setText("(二)張京兆畫眉");
		
		
	}
	private void showString(){
		speakString = "望渠消息向長安常把菱花仔細看見說文書將入境今朝喜色上眉端"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20009%E7%B1%A4.jpg" ;//圖
		
		str1="名與利。必至頭。訟必勝。病即瘳。孕生男。婚可求。行人至。百無憂。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="謀望已久。忽得好音。音書到手。喜在目今。利有攸往。財獲千金。所謀遂意。凡事稱心。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="行人若久望。只在三日至。自去自回歸。不出百日內。";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤謀事尚遠。自己心急。他人不知。若問遠行。只在百日之內。婚姻有期合。病者宜請禱。大概空虛無的實也";//解曰
		str11="望待也。長安帝畿也。文書入境。有喜信也。若代人問名利。主日下帝畿內。有佳音來報。本身自占。名利則是虛喜。";//釋義
		str12="消息菱花與見說。喜色無一字著。實凡百謀望皆空。指望占者詳之。又一女子占夫之信。得此籤。果有家報至。";//占驗
		str13="(一)宋太祖陳橋即位\n宋太祖趙匡胤。仕局為檢點。世宗崩。子恭帝立。僅數歲。(趙)奉命往伐河東。兵至陳橋。部下將士以主幼政亂。勸太祖即位。初不許。後乘太祖醉臥。以黃袍加體。乃引兵回東。受周恭帝禪位。(恭帝當年七歲。皇后新寡。兵變比禪讓更合)";//故事	
	}
	@Override
