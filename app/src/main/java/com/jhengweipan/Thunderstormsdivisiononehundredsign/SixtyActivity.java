...
public class SixtyActivity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第六十籤");
		text2.setText("【 上上。己癸】");
		text4.setText("羨君兄弟好名聲");
		text5.setText("一意謙撝莫自矜");
		text6.setText("丹詔槐黃消息近");
		text7.setText("巍巍科甲兩同登");
		text8.setText("(一)宋郊兄弟同科");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "羨君兄弟好名聲一意謙撝莫自矜丹詔槐黃消息近巍巍科甲兩同登"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20060%E7%B1%A4.jpg" ;//圖
		
		str1="宜出入。好謀望。訟即決。財亦旺。 孕生男。病無恙。信音回。有神相。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="";//東坡解
		str5="兄弟聯芳。聲名自起。凡事謙偽。以全其美。 前程遠大。好事近矣。兩兩高擢。同登甲第。";//東坡解一
		str6="兄弟聯芳。聲名自起。凡事謙撝。以全其美。前程遠大。好事近矣。兩兩相高。同登甲第。";//東坡解二
		str7="同志同登兩得仙。時來凡事合先鞭。 所謀所望皆如意。福祿榮華件件全。";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤百般如意。謀事有成。出入好。求財多。高登科。訟必解。病即癒。財方旺。功名必得。行人即至。孕生男。婚必合。宅舍吉。神明相助也。";//解曰
		str11="大器既成。許掇高弟。如兄占弟。弟必利。弟占兄。兄必利。兄弟同科。必主聯芳。然得意者多矜。故當謙偽。則天祐神助。前程遠大。凡事占之。至秋大利。家宅得此。主兄弟和睦。妻孥好合。同字或作重。";//釋義
		str12="一人被報築城大戶。占此。有司簽之不得免。不一年又令重築。似此則不當論。籤訣之可否。惟視所占之事如何耳。";//占驗
		str13="(一)宋郊兄弟同科\n宋。宋郊。弟都。雍邱人。天聖初與弟同舉進士。未第時。有僧相之云。小宋當大魁天下。大宋亦不失功名。後數日僧見郊。異之曰。君何滿面陰騭紋。似救數萬生命者。郊曰惟前日見蟻被水掩。戲將竹編橋渡之。僧曰即此便是當大魁天下。後果然。";//故事	
	}
	@Override
