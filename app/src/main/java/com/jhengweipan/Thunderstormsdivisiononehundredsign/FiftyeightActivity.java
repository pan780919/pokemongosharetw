...
public class FiftyeightActivity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第五八籤");
		text2.setText("【 上吉。己辛】");
		text4.setText("蘇秦三寸足平生");
		text5.setText("富貴功名在此行");
		text6.setText("更好修為陰騭事");
		text7.setText("前程萬里自通亨");
		text8.setText("(一)蘇秦背劍  \n蘇秦說 趙王");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "蘇秦三寸足平生富貴功名在此行更好修為陰騭事前程萬里自通亨"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20058%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="病即安。訟決勝。行人回。婚宜定。孕生男。家道盛。積陰功。福來應。";//聖意一
		str3="病即安。訟決勝。行人回。婚宜定。孕生男。家道盛。積陰功。福自應。";//聖意二
		str4="";//東坡解
		str5="凡百謀望。遠行則吉。求財必豊。求名必得。 更行好事。以助陰騭。富貴榮華。始自今日。";//東坡解一
		str6="凡百謀望。遠行則吉。求財必豐。求名必得。 更行好事。以助陰騭。富貴榮華。始自今日。";//東坡解二
		str7="孕則生男財則遂。功名到底可相期。 作事有成終有望。凡人皆可問謀為。 ";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤只宜謹慎。不可強為。防有口舌之憂。莫聽人言。方可無事。婚宜定。訟決勝。病遇良醫即愈。凡謀望遠行則吉。求財豊原。功名必得。要修陰德。自然福祿全成。";//解曰
		str11="蘇秦憑三寸舌佩相印。謂以口舌得官也。(憑三寸舌本作坤二寸占)占者得此。主賴口才之助。富貴可得。但當修為陰騭。則前程遠大。萬里者遠大之意。凡事當遂行勿遲疑。謹慎自守。不可欺詐。卻得無虞。問事與病。遇蘇秦二姓之人則吉。名利遠行可得。鄉邦未遂。";//釋義
		str12="功名初次占之不應。須第二次占之方有成就。以蘇秦再出。始懸相印也。";//占驗
		str13="蘇秦背劍_蘇秦說 趙王\n戰國。蘇秦既說秦不行。乃歸家發憤苦讀。研究太公陰符。學成即指秦往說趙王。以合從拒秦。起王大悅。（起字可能為趙之誤植）為治裝并說齊楚魏。趙王乃秦。竟佩六國相印。使秦兵十五年不敢出函谷關。";//故事	
	}
	@Override
