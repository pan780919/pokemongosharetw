...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第三六籤");
		text2.setText("【 上吉。丁己】");
		text4.setText("功名富貴自能為");
		text5.setText("偶著先鞭莫問伊");
		text6.setText("萬里鵬程君有分");
		text7.setText("吳山頂上好鑽龜");
		text8.setText("(一)羅隱求官");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "功名富貴自能為偶著先鞭莫問伊萬里鵬程君有分吳山頂上好鑽龜"; //郎誦文字
		photoStr = "" ;//圖
		
		str1="名與利。在晚成。訟得理。病漸亨。 問遠信。阻行程。婚可合。孕將生。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="富貴分定。遲速有時。藏器以待。切莫怨遲。 掀天事業。時至即為。若到天邊。便可決疑。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="榮華有分。未得其時。 他人早達。切莫恨遲。 ";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤不可躁進。欲速則不達。富貴遲速有時。若在家則困苦。出外則震亨。不宜守舊。訟得理。名利晚成。行人阻。婚必成。病漸安。先凶後吉也。";//解曰
		str11="窮通得喪。出於偶然。各有其時。凡事成之。必在於後。鵬程。名利之程。吳山即吳越之山。高宗即位。播遷至越。功名之會。南至於此。以應選。占者亦當進圖功名。好鑽龜者。謂占其用否之兆。自能為者。要在人當修為。以待時。不可委於時之未至。而嗟歎也。求財南方有。北方不穩。";//釋義
		str12="一淅中人。父子因兵失散。占此。因上吳山卜卦。至廟門。見有父尋子招貼。遂訪見其父。驗如此。又龔廣文。將應院試。占此。時學政吳伯新。尚書也。果入泮。";//占驗
		str13="(一)羅隱求官\n唐。羅隱。字昭諫。錢塘人。工詩。稱為羅江東。吳越錢鏐辟為徒。事節度判官副使。嘗說。鏐討朱溫縱無功。猶可保杭越。奈何交臂事賊。圖謀顯達為終。古之羞乎。著作甚多。";//故事	
	}
	@Override
