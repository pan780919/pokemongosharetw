...
public class Page_66Activity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第六六籤");
		text2.setText("【 上上。庚己】");
		text4.setText("耕耘只可在鄉邦");
		text5.setText("何用求謀向外方");
		text6.setText("只見今年新運好");
		text7.setText("門闌喜氣事雙雙");
		text8.setText("(一)杜甫遊春");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "耕耘只可在鄉邦何用求謀向外方只見今年新運好門闌喜氣事雙雙"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20066%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="病即安。訟即決。財漸豊。名高揭。 行人回。婚可結。莫外求。福儘得。";//聖意一
		str3="病即安。訟即決。財漸豐。名高揭。 行人回。婚可結。莫外求。福儘得。";//聖意二
		str4="出外不宜。在家必達。時運將亨。財祿俱發。 好事重重。門庭改革。若欲遠圖。弄巧成拙。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="自家安分莫他求。自有榮華切莫憂。 喜得一陽天氣象。也知春煖勝三秋。";//碧仙註一
		str9="自家安分莫他求。俯仰寬舒得自由。 現在陽和春已到。桃紅李白樂悠悠。"; //碧仙註二
		str10="此籤不宜遠行。只宜守舊。自有超達。時運漸亨。財祿俱發。訟不宜。財自至。婚可求。名利高。病獲安。孕生貴子。風水利順。家宅昌隆也。";//解曰
		str11="名利只宜近處。不宜遠行。守舊好。進步難見。說新運好者。不是決。許其好。尚當待時發達也。占此者。凡事皆利。且得護喜。婚姻事尤宜。耕耘或作經營。向字或作出字。";//釋義
		str12="正德間。京師揚惟聰占此。後以鼎元歷官翰苑。至宮保學士尚書。凡十餘任。並不出京。正應首句。";//占驗
		str13="(一)杜甫遊春\n唐。杜甫。字子美。杜陵人。玄宗朝獻賦。命待詔集賢院。後轉檢校工部員外。卻甫覽君書。善為詩歌。涵渾汪洋。千態萬狀。陳時事。確切精深。世號詩史。元禎謂。詩人以來。未有如子美者。惟好賞春山。故每當春晴。必遊郊外。";//故事	
	}
	@Override
