...
public class Page_93Activity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第九三籤");
		text2.setText("【 中平。癸丙】");
		text4.setText("春來雨水太連綿");
		text5.setText("入夏晴乾雨又愆");
		text6.setText("節氣直交三伏始");
		text7.setText("喜逢滂沛足田園");
		text8.setText("(一)邵康節定陰陽");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "春來雨水太連綿入夏晴乾雨又愆節氣直交三伏始喜逢滂沛足田園"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20093%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="財聚散。病反覆。欲求安。候三伏。事進退。宜作福。婚可成。審往復。 ";//聖意一
		str3="財聚散。病反覆。欲求安。候三伏。事進退。宜作福。婚可成。慎往復。";//聖意二
		str4="盈虛消息。天道之常。春多如意。夏卻乖張。 直交三伏。時運方昌。財多積聚。事事平康。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="舉意方濃卻未成。百般阻滯隔人情。 直須忍耐毋求速。至否之中有泰亨。";//碧仙註一
		str9="雨後久晴晴又雨。吉凶反覆皆如此。 艱危正值倒懸時。恰有天緣方在邇。"; //碧仙註二
		str10="此籤謀望中有阻滯。後必安康。訟反覆。久方決。問病庚日安。婚宜細審可成。行人遲。孕生女。凡事不可強求。靜以安身也。";//解曰
		str11="盈虛消息。天道之常。吉凶禍福。人事之常。占此春間方得遂意。夏主乖張。過三伏之後方泰。問嗣主生二子。問病反覆。主寅午日見凶。";//釋義
		str12="一人問終身。占此自解曰。四十一歲後當大發。人問故。曰。夏至三庚。入初伏。四庚中伏。五庚三伏。我庚申生。十一庚午。二十二庚辰。三十一庚寅。四十一庚子。是五庚也。非三伏之始乎。後果然。";//占驗
		str13="(一)邵康節定陰陽\n宋。邵雍。字堯夫。諡康節。精先天河圖。術數。著太極圖說。祖方士陳博之學。復定陰陽。推八卦。著皇極經世。初王拱辰伊洛以雍應詔。除主簿不就。熙寧二年。呂誨吳充。復薦除推官。仍辭。年六十七卒。贈著作郎元祐中。韓維清再奏。請予諡康節。";//故事	
	}
	@Override
