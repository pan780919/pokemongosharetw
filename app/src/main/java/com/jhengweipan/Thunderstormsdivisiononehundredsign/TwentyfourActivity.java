...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二四籤");
		text2.setText("【 中平(中吉)。丙丁】");
		text4.setText("一春萬事苦憂煎");
		text5.setText("夏裏營求始帖然");
		text6.setText("更遇秋成冬至後");
		text7.setText("恰如騎鶴與腰纏");
		text8.setText("(一)張騫誤入斗牛宮");
		text9.setText("(二)端木結駟連騎");
		
		
	}
	private void showString(){
		speakString = "一春萬事苦憂煎夏裏營求始帖然更遇秋成冬至後恰如騎鶴與腰纏"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20024%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="名利有。莫躁為。詞訟解。婚姻宜。 行人遠。病瘥遲。富與貴。自有時。 ";//聖意一
		str3="名利有。莫躁為。詞訟解。婚姻宜。行人遠。病瘥遲。富與貴。要待時。";//聖意二
		str4="春日謀望。事多不成。夏秋冬月。始見光亨。 更宜出入。福祿豐盈。營求如意。時至即行。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="如舟上高灘。險後得平安。 勞心勤苦過。財氣不艱難。";//碧仙註一
		str9="舟楫上高灘。險後得平安。勞心勤苦過。財氣不艱難。"; //碧仙註二
		str10="此籤先難後易。官員占之。有超擢之喜。士人占之。名利晚成。凡諸謀望。只是後好。訟終解。婚姻宜。行人遠。病難好。凡事可為。自有成就也。";//解曰
		str11="昔人一欲富。一欲貴。一欲仙。一欲腰纏十萬貫。騎鶴上揚州。時揚州吏最稱為富貴仙也。但此人有是說無是事。欲求名利者。皆安於義命。不可妄為。凡事夏秋冬。但遂意。惟春則不利也。";//釋義
		str12="一人謁選。占此謂必得揚州為官矣。乃選得河南信陽州知州。陽與揚同音。恰如二字之驗。(帖/騎或作揚)";//占驗
		str13="(一)張騫誤入斗牛宮\n漢。張騫。城固人。武帝時。奉命使大月氏。開西南夷。嘗乘槎。直上天河。入斗牛宮。見一女子。手弄金梭。傍有一石。問之不答。惟云可問嚴君平便知。君平蜀人。精天文術數。往詢之。云此天孫(仙)織女也。石名支磯石。";//故事	
	}
	@Override
