...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第四籤");
		text2.setText("【下下。甲丁】");
		text4.setText("去年百事可相宜");
		text5.setText("若較今年時運衰");
		text6.setText("好把瓣香告神佛");
		text7.setText("莫教福謝悔無追");
	...
	private void showString(){
		speakString = "去年百事可相宜若較今年時運衰好把瓣香告神佛莫教福謝悔無追"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20004%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="功名無。財祿輕。訟宜息。婚未成。病難癒。行阻程。若求吉。禱神明。";//聖意一
		str3="功名無。財祿輕。訟宜息。婚難成。病難癒。行阻程。若求吉。禱神明。";//聖意二
		str4="先吉後凶。時運將否。謀事無成。頓非前比。秉誠禱神。以求福祉。若無遠慮。悔無及已。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="好事連綿過。時衰禍漸來。頂天並拜地。庶可保無災。";//碧仙註一
		str9="好事從前過。時衰禍漸來。頂天並拜地。庶可保無災。"; //碧仙註二
		str10="此籤吉事已去。凶將漸來。祈禱神明。以保平安。官事臨身。是非自見。凡事謀望主不成。求財交易不就。所為皆不利也。";//解曰
		str11="此言名利之機。禍福之由也。尤當預圖。免致噬臍。悔之晚矣。今年時運衰。言謀事不利。眷屬不寧。但當側身祈禱。則變災為福。凡事先凶後吉。運字或作漸字";//釋義
		str12="一人平日許下香愿。後患病。占此。輒以未酬香願。為疑不及禱而死。瓣香告神佛。福謝悔無追。二語靈甚。";//占驗
		str13="(一)小秦王三跳澗\n\n小秦王即唐太宗李世民。找劉武周時。被其部將尉遲恭所迫。三跳澗而逃。幾乎不免(難)。幸遇秦叔寶救之。";//故事	
	}
	@Override
