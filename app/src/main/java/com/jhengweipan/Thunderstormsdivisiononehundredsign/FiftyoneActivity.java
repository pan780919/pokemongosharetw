...
public class FiftyoneActivity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第五一籤");
		text2.setText("【 上吉。己甲】");
		text4.setText("君今百事且隨緣");
		text5.setText("水到渠成聽自然");
		text6.setText("莫嘆年來不如意");
		text7.setText("喜逢新運稱心田");
		text8.setText("(一)御溝流紅葉");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "君今百事且隨緣水到渠成聽自然莫嘆年來不如意喜逢新運稱心田"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20051%E7%B1%A4.jpg" ;//圖
		
		str1="名漸顯。訟漸寬。財自裕。病自安。 行有信。婚可定。命漸亨。心必稱。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="目下謀望。且隨緣分。一朝榮達。身顯如願。 休自嗟怨。待時遷變。漸遇亨通。好事疊見。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="一生勞碌不曾閒。也是心緣倍累關。 漸遇亨通有生意。後來容易嘆先難。";//碧仙註一
		str9="一生勞碌不曾閒。也是心緣倍累關。漸遇亨通堪稱意。後來容易嘆先難。"; //碧仙註二
		str10="此籤好事重重。名利漸達。財緩發。婚可定。行人有信。病漸安。訟得理。時運亨泰。孕生貴子。風水合利。自有稱心之望也。";//解曰
		str11="目下功名謀為。多不如意。且隨分而行。所謂莫歎不如意。以後來極容易者也。直須交運眼。或交節候。自然漸亨。重重好事。稱吾心田。占此大抵先否後泰。";//釋義
		str12="一人占得此籤。屢涉江湖不利。一人解之自君命。日子屬土。以水為財。四柱無水。屢行不遂。三年之後行癸水。自當大發。其後果然。應水到渠成。喜逢新運之驗也。";//占驗
		str13="御溝流紅葉\n唐朝。宣宗宮內。韓夫人不蒙寵辛。偶向紅葉題詩一首。流出御溝。一應試官人。顧況(于佑)於御溝邊。拾得紅葉。上題詩云。流水何太急。深宮盡日閒。殷勤謝紅葉。好去到人間。況亦拾紅葉。戲和之云。愁見鶯啼柳絮飛。上陽宮女斷腸時。君恩不禁東流水。葉上題詩寄與誰。也從御溝中流將進去。天子知此事。卻把韓夫人嫁與于佑。夫婦百年偕老。(按御題葉名有田。姑錄其一)。";//故事	
	}
	@Override
