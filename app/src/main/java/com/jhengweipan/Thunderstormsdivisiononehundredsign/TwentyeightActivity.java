...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二八籤");
		text2.setText("【 上吉。丙辛】");
		text4.setText("公侯將相本無種");
		text5.setText("好把勤勞契上天");
		text6.setText("人事盡從天理見");
		text7.setText("才高豈得困林泉");
		text8.setText("(一)相如題橋");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "公侯將相本無種好把勤勞契上天人事盡從天理見才高豈得困林泉"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20028%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="病與訟。久方解。名與利。姑少待。 若失物。尋必在。雖漸困。終必泰。";//聖意一
		str3="病與訟。久方解。名與利。姑少待。若失物。尋必在。雖暫困。終必泰。";//聖意二
		str4="";//東坡解
		str5="榮華富貴。勤苦得之。目下雖困。後必逢時。切勿自怠。更勉修為。人事既盡。天理可知。";//東坡解一
		str6="榮華富貴。勤苦得之。目下雖困。後必逢時。切勿自怠。更勉修為。人愁既盡。天理可知。";//東坡解二
		str7="但存平等心。所作皆無慮。若不勤謹修。歡處必生事。";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤吉利。凡事切莫歎息。更須修心向善。自有好處。問訟。久方決。名利達。失物尋在。病宜祈保。行人還。求財得。";//解曰
		str11="人之富貴。勤苦可得。豈限白屋朱門之說。所謂本無種者也。目下雖困。而未逢時。切莫嗟嘆。但當勇為。若才高而人事已盡。則天必假手薦拔。不求而自至矣。名有天理之報。財有守時之益。凡事只當循乎理法。不可妄為也。";//釋義
		str12="一士人林某。問終身。占此後。習武不利。加納為泉州府牧。終於任。又馬生。歲科試。皆列三等。及占此。加考古學。竟以擬上林賦冠軍。遂得補廩。";//占驗
		str13="(一)相如題橋\n漢。司馬相如。成都人。未遇時。嘗遇橋。見貴者車馬喧騰。慨然曰。大丈夫當如是。因題橋以見志。作子虛上林賦。武帝讀而善之。召見以為郎。會唐蒙驚憂。巴蜀遣相如責之。上乃拜相如為中郎將。後有人上書告。相如使時受金。失官居歲餘。復召為郎。";//故事	
	}
	@Override
