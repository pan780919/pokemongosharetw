...
public class Page_61Activity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第六一籤");
		text2.setText("【 中平(中吉)。庚甲】");
		text4.setText("嘯聚山林兇惡儔");
		text5.setText("善良無事苦煎憂");
		text6.setText("主人大笑出門去");
		text7.setText("不用干戈盜賊休");
		text8.setText("(一)蒯輒見韓信");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "嘯聚山林兇惡儔善良無事苦煎憂主人大笑出門去不用干戈盜賊休"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20061%E7%B1%A4.jpg" ;//圖
		
		str1="財平平。病漸效。訟自散。莫與較。 遠行歸。婚亦宜。雖有險。終平夷。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="";//東坡解
		str5="惡少操心。欲害良善。彼何能為。徒逞強健。 君子善勝。收功不戰。有神相之。陰消禍變。";//東坡解一
		str6="惡少操戈。欲害良善。彼何能為。徒逞強健。君子善勝。收功不戰。神明相之。陰消禍變。";//東坡解二
		str7="";//碧仙註
		str8="心驚如踏一層冰。長敬番成度量生。一葦一航波浪足。駸駸喜色藹門庭。";//碧仙註一
		str9="心驚如踏一層冰。戒懼何憂險阻深。一葦一航波浪定。駸駸喜色靄門庭。"; //碧仙註二
		str10="此籤主有驚險。防小人侵害。若能守性存善。卻有德曜及身。神明助之。陰消禍變。病恐險。訟必散。財平平。婚宜審。凡事有陰。及後平和。";//解曰
		str11="灌嬰將兵擊尉陀。人民驚恐。神在南越山上。告將軍曰。干戈不動。而盜賊遽休。後果奏凱。占此主小人侵害。事多驚恐。若能修福。則惡不能侵害。危病小口(心)無事。家主見凶。凡事先憂後喜。名利險中可得";//釋義
		str12="一生試事畢。卜捷音。占此後。不得中榜。則此籤大不利於求名也。";//占驗
		str13="(一)蒯輒見韓信\n漢。蒯輒。字通。范陽人。時韓信假節為齊王。輒知天下權在韓信。往說之曰。今大王威震天下。與楚則楚勝。與漢則漢勝。大王若不楚不漢。鼎足三分。可長保富貴。信謝之曰。吾受漢王厚恩。終身不忍背漢。後信被呂后所殺。臨刑有悔不聽蒯通之言。";//故事	
	}
	@Override
