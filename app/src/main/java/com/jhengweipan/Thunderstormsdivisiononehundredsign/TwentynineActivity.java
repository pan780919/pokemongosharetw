...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二九籤 ");
		text2.setText("【 上上。丙壬】");
		text4.setText("祖宗積德幾多年");
		text5.setText("源遠流長慶自然");
		text6.setText("若更操修無倦已");
		text7.setText("天須還汝舊青氈");
		text8.setText("(一)司馬溫公嗟困");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "祖宗積德幾多年源遠流長慶自然若更操修無倦已天須還汝舊青氈"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20029%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="天福善。產貴子。病者安。訟得理。 名必得。仍得利。行人歸。皆如意。";//聖意一
		str3="天福善。產貴子。病者安。訟得理。 名必遂。仍得利。行人歸。皆如意。";//聖意二
		str4="善惡胚胎。由人自栽。修善暑泰。積惡者災。 若能修持。福自天來。依舊榮華。自有安排。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="積善之家。必有餘慶。子孫眾多。 門戶昌盛。好修福祿。前程順應。";//碧仙註一
		str9="積善之家。必有餘慶。子孫眾多。門戶昌盛。好修福祿。前程順意。"; //碧仙註二
		str10="此籤。士人占之大吉。官員占之高擢。庶人占之終有發達。訟得理。病易安。婚必成。名利遂。行人即回。凡事如意。但要修心積善方好。不可著急也。";//解曰
		str11="凡事多得遂意。此皆祖宗積德所致。若果能順理而行。去其欺害。則天之報施。決然不爽。青氈者。舊物也。運乃失而復得。否而復泰也。操修或作修為。";//釋義
		str12="一士以文考黜。占此。下科竟復優等。應在四句。又晉江王生。其祖父素世與考不利。即生日已。府縣試亦會。取結前。予而院考仍無名。光緒。乙亥。將應院試。入廟禱祈。占此。自謂無望。迨榜發。竟取進。因該生頗寒。欲做青衣。苦於無力不已。轉向親朋借舊者。漸川(穿)至簪掛日。諸同案皆衣冠蹌濟。而彼獨穿舊青衣。始悟神示靈驗異常。";//占驗
		str13="(一)司馬溫公嗟困\n宋。司馬光。夏縣人也。次子寶元初進士。累官端明殿學士。嗟歎民困。上疏極言新法不便。哲宗初立。召拜左僕射。罷青苗法。人謂元祐相(祖)業。有旋乾轉坤之功。卒贈太師。封溫公。諡文正。";//故事	
	}
	@Override
