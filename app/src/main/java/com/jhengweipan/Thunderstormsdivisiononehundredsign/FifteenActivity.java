...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第十五籤");
		text2.setText("【 中平。乙戊】");
		text4.setText("兩家門戶各相當");
		text5.setText("不是姻緣莫較量");
		text6.setText("直待春風好消息");
		text7.setText("卻調琴瑟向蘭房");
		text8.setText("(一)張君瑞憶鶯鶯");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "兩家門戶各相當不是姻緣莫較量直待春風好消息卻調琴瑟向蘭房"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20015%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="婚未合。訟未決。名利遲。音信缺。 孕難生。防口舌。非知己。莫妄說。";//聖意一
		str3="婚未合。訟未決。名利遠。音信缺。 孕難生。防口舌。非知己。莫妄說。";//聖意二
		str4="";//東坡解
		str5="兩意未合。宜於待時。防憂與慮。謹慎愆非。 直待來春。萬事方吉。若或妄動。徒勞心懷。";//東坡解一
		str6="兩意未合。宜於待時。防憂與患。謹慎愆期。直待來春。萬事方佳。若或妄動。徒勞心懷。";//東坡解二
		str7="兩家未合。百事難諧。 門戶可慮。猷恐成乖。";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤名不成。利不就。婚不合。 凡事卻待新春。方始稱意。若妄作。反勞心力。終不能如人心願也。";//解曰
		str11="各相當者。謂情不能諧也。主骨肉有言語口舌之傷矣。 其物換人移。方得。妻子和合。父母克諧。 若或妄為。徒勞無益。直遇寅卯辰年月日。名利皆有。百事合宜也。";//釋義
		str12="一人春間往楚經商。卜此。謂秋間必返。及到彼。因事羈留。 剛到明春抵家。末二句驗甚。";//占驗
		str13="(一)張君瑞憶鶯鶯\n唐。張拱(張珙)字君瑞。因事出蒲東。寄寓普救寺。 寺之西廂。有崔氏母女居焉。即君瑞之中表親。 女名鶯鶯。有絕色。會值流寇之亂。 崔母許以。如能保護。願將女妻焉。 君瑞出偽護持。乃免於難。後崔母背盟。 君瑞思憶成病。識者謂其不出道所致也。 ";//故事	
	}
	@Override
