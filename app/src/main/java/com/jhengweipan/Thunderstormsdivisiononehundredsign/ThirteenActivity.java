...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第十一籤");
		text2.setText("【下下。乙甲】");
		text4.setText("今年好事一番新");
		text5.setText("富貴榮華萃汝身");
		text6.setText("誰識機關難料處");
		text7.setText("到頭獨立轉傷神");
		text8.setText("(一)韓信功勞不久");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "今年好事一番新富貴榮華萃汝身誰識機關難料處到頭獨立轉傷神"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20011%E7%B1%A4.jpg" ;//圖
		
		str1="莫貪求。名未遂。財祿平。訟不利。病者凶。事不濟。問行人。多阻滯。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="命運難亨。亦不如意。吉中有凶。事實無濟。切莫貪求。出外不利。如或妄動。福消禍至。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="作事須宜慎。人心隔肚皮。用心防算險。百事自合宜。";//碧仙註一
		str9="作事須宜慎。人心隔肚皮。用心防算險。百事允相宜。"; //碧仙註二
		str10="此籤宜更改方得財祿。要知足。不可與人其事。恐機事不密。反成禍敗。官有旌麾之喜。孕生男。士有超拔之喜。訟者勝。婚不吉。";//解曰
		str11="此籤卻要知道吾人處世。當見機而作。今年命運。雖吉未吉。似亨未亨。欲問孕生男。終難長養。底於有成。難料處言。事有變幻。凡事占之徒勞心力。若強為。到底無益。立字一作力字。";//釋義
		str12="一生到省。考遺才。占此。不錄。至返家時。乏騎步行。應轉傷神也。又兩商人同往茶山採茶。多年蝕本。欲收場。未決。故托人占此。或勤再做。一信之。一不聽。遂折股。其一人將資本攜歸。中途得病。到歲杪。尚在旅寓獨宿。末句驗甚。一人再整適茶葉。失收。但人心太寒。無敢買。被獨廣購。果大有獲。改因轉賣(賣本作左貝右僕心僕去人)洋船。乃敗。全詩俱應。末句到頭獨立。功極。轉傷神三字尤妙。";//占驗
		str13="(一)韓信功勞不久\n漢韓信。准陰人。佐漢高帝定天下。虜魏。破趙。降燕。下齊。滅楚。建十大功勳。初封楚王。高祖深忌其能。後偽遊雲夢。執歸降。封淮陰侯。乃不自損抑。務伐己功。致有殺身赤族之禍。亡年僅三十二歲。雖有功勞。不久於世。";//故事	
	}
	@Override
