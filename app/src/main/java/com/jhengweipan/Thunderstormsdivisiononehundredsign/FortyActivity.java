...
public class FortyActivity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第四十籤");
		text2.setText("【 上吉 。丁癸 】");
		text4.setText("新來換得好規模");
		text5.setText("何用隨他步與趨");
		text6.setText("只聽耳邊消息到");
		text7.setText("崎嶇歷盡見亨衢");
		text8.setText("(一)漢光武陷昆陽");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "新來換得好規模何用隨他步與趨只聽耳邊消息到崎嶇歷盡見亨衢"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20040%E7%B1%A4.jpg" ;//圖
		
		str1="名終成。訟得勝。孕生男。保無病。 行人回。婚宜定。事須遲。有餘慶。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="謀望更改。修為儘好。何必依人。自可達到。 須歷艱難。必獲好報。平步青霄。榮捧恩詔。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="好把工夫改換般。門庭增喜轉眉攢。 文書到手皆成就。宜訟宜婚病亦安。";//碧仙註一
		str9="改換規模又一般。門庭增喜轉眉顏。 文書到手皆成就。宜訟宜婚病亦安。"; //碧仙註二
		str10="此籤謀望更變儘好。莫聽人言閑是閑非。何必依人。自可遠到。名後成。訟得勝。孕生子。保無病。行人回。婚宜定。凡事宜。遲必有餘慶也。";//解曰
		str11="百事規模多。主更變。名利遲遲。若能歷涉艱難。必獲薦拔。平步青霄。榮捧恩詔。以處順境。占者只宜守己。不可隨人是非。以招禍患。始孕生女。次孕生男。自用則吉。用人則凶。";//釋義
		str12="吳下一富生。隨友南京。援例占此後。因循花柳金用過半。而事不成後。過耿姓年諠。稍為青口。竟以儒士。得中鄉試。應在後三句。";//占驗
		str13="漢光武陷昆陽\n漢。光武帝。劉秀尚王末。兵至昆陽。莽命王邑士尋將兵百餘。萬井驅虎豹犀象。以助軍威。光武兵僅數萬。自將步騎千餘。為前鋒。破其前軍。諸將繼進。莽兵大潰。會大風雨。虎豹股慄被殺。尋邑遁去。盡獲其軍實輜重。東漢之興。賴此戰也。";//故事	
	}
	@Override
