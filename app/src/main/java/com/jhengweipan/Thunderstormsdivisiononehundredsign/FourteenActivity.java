...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第十四籤");
		text2.setText("【 下下。乙丁 】");
		text4.setText("一見佳人便喜歡");
		text5.setText("誰知去後有多般");
		text6.setText("人情冷暖君休訝");
		text7.setText("歷涉應知行路難");
		text8.setText("(一)郭華戀王月英");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "一見佳人便喜歡誰知去後有多般人情冷暖君休訝歷涉應知行路難"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20014%E7%B1%A4.jpg" ;//圖
		
		str1="始雖易。終則難。名利失。病未安。 訟反覆。孕生女。行未歸。事多阻。 ";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="事望團圓。反生齟齬。人多不情。恐難憑據。 只宜自省。無為他誤。戒之戒之。且疑且慮。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="乍喜反成憂。虛花總不收。 世情多反覆。守己是良謀。";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤先喜後憂。不宜放肆。大概親而又陳。合而復離。歷涉險阻。竟無成。尤兢兢業業。庶免後悔。";//解曰
		str11="大抵此籤。好事難成。親中招怨。惹禍難免。婚不宜成。占此不可托人。宜自周旋。免得後日之悔。曰樂天諷諫。曰行路難。不在水兮不在山。人情反覆。問是也。應字或作方字亦通。";//釋義
		str12="一士父母。為之求婚。己私。占此。不敢竟白。後果因貧富。久而不諧。六禮將畢而復悔。";//占驗
		str13="(一)郭華戀王月英\n胭脂記。宋郭華。治陽人。往汴京。赴試。因戀胭脂舖女。王月英之美。落第不歸。羈留汴京。與之約期私會。屆期。王月英至。值郭華酒飲過醉。推擠不醒。乃解日鞋。藏華懷中而回。華醒時。見鞋悔恨。仰吞而死。是何為。出門不知過。欲者戒焉。";//故事	
	}
	@Override
