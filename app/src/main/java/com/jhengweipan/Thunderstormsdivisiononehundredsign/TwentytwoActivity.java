...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二二籤");
		text2.setText("【 上吉。丙乙】");
		text4.setText("碧玉池中開白蓮");
		text5.setText("莊嚴色相自天然");
		text6.setText("生來骨格超凡俗");
		text7.setText("正是人間第一仙");
		text8.setText("(一)李太白遇唐明皇");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "碧玉池中開白蓮莊嚴色相自天然生來骨格超凡俗正是人間第一仙"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20022%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="訟決勝。名易成。病即愈。財速盈。 婚姻合。貴子生。家道泰。百事亨。";//聖意一
		str3="訟決勝。名易成。病即愈。財即盈。婚姻合。貴子生。家道成。百事亨。";//聖意二
		str4="";//東坡解
		str5="事易明白。不假人為。更宜出入。切莫遲疑。 士人占之。高攀桂枝。一切謀望。宜趁明時。";//東坡解一
		str6="事易明白。不假人為。更好出入。切莫遲疑。 士人占之。高攀桂枝。一切謀望。宜趁明時。";//東坡解二
		str7="更宜出入莫遲疑。士子高攀折桂枝。 婚合自然生貴子。萬般謀望趁明時。";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤可謀財。可望事。若有現成。不圖自至。不勞心力。訟已決。名利成。病則愈。婚則成。凡事皆成就也。";//解曰
		str11="花在上實在下。功名謀望。若在晚景。求則得之。不勞心力。早年未遂。病(者)。有孕吉。無孕凶。問婚。得舊配。問孕生女。謀事夏秋則吉。璧玉池中開白蓮者。乃仙所有。有疑是空談之說。占者慎之。";//釋義
		str12="一生聞鄰邑考童生。欲往。占此後。為彼地所遂。路見一觀音坐白蓮。竟買之而還。又余表叔。陳內史府試。占此籤。果結第一名。應在末句也。又泉州有一副貢生鄉試。占此。竟中式。蓋應正是兩字也。董事王錢識。";//占驗
		str13="(一)李太白遇唐明皇\n唐。李白。字太白。成紀人。性倜儻。善詩歌。天寶中召見金鑾。論當世事。詔供奉翰林。(唐)明皇愛其才。欲官之。會高力土。以脫靴為恥。讚於楊貴妃。輒為所沮。遂浮遊四方。寓情詩酒。";//故事	
	}
	@Override
