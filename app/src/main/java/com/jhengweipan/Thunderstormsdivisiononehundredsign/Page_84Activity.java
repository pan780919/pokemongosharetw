...
public class Page_84Activity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第八四籤");
		text2.setText("【 中平。壬丁】");
		text4.setText("君家事緒更紛然");
		text5.setText("當局須知一著先");
		text6.setText("長舌婦人休酷聽");
		text7.setText("力行禮義要心堅 ");
		text8.setText("(一)須賈害范雎");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "君家事緒更紛然當局須知一著先長舌婦人休酷聽力行禮義要心堅 "; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20084%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="訟宜解。莫信讒。財緩求。名莫貪。孕生女。行人還。婚更審。莫妄攀。";//聖意一
		str3="訟宜解。莫信讒。財緩求。名莫貪。孕生女。行人還。婚更審。";//聖意二
		str4="萬事一理。各有先見。莫聽人言。激成多變。 依理而行。禍自可免。當堅乃心。毋或退轉。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="雨下相謀要見他。更然未可便平和。 若從音信求安靜。只恐將來事轉多。";//碧仙註一
		str9="理煩治劇有先幾。莫聽纔言是與非。 任爾風濤千萬狀。漁翁穩坐釣魚磯。"; //碧仙註二
		str10="此籤占之。謀望平心。禍去福來。若強求。福轉生禍貽。病則安。訟宜和。休聽讒言。財有失。名勿貪。婚莫強求。行人至。或有失物。隨機應變。可得陰人。切莫交言。須謹慎也。";//解曰
		str11="言事之未來。既要先見。又要豫圖。莫聽人言。致生變故。名利進步。則得遲疑。則失慎。勿貪取。依理而行。隨機而應。不患眾事之紛也。長舌婦人是陰人之言。決不可聽也。";//釋義
		str12="一人惑於婦言。欲與弟分居。占此遂止。其後因弟克勤克儉。興財致富。其兄安享終身和樂。聖言之化人也如此夫。";//占驗
		str13="(一)須賈害范雎\n戰國。范睢。字叔。魏人。事須賈。使齊攘王賜金及牛酒。睢辭。賈知之。歸告魏杞。魏齊。齊怒答(笞)擊雎。折脅摺齒。雎佯死得脫。入秦說昭王。拜相。須賈使秦。睢敝衣微眼。至邸見賈。賈驚曰。范叔固無恙乎。何一寒至此。乃取綈袍贈馬。睢以賈有故人風。釋之。";//故事	
	}
	@Override
