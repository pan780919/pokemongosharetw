...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第三一籤");
		text2.setText("【 中吉。丁甲】");
		text4.setText("秋冬作事只尋常");
		text5.setText("春到門庭漸吉昌");
		text6.setText("千里信音符遠望");
		text7.setText("萱堂快樂未渠央");
		text8.setText("(一)蘇卿負信");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "秋冬作事只尋常春到門庭漸吉昌千里信音符遠望萱堂快樂未渠央"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20031%E7%B1%A4.jpg" ;//圖
		
		str1="訟漸理。病漸康。財始達。名始彰。 行人近。婚姻良。家道吉。福祿昌。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="";//東坡解
		str5="凡百謀望。秋冬平平。春來運至。次第光亨。 遠行有信。所作皆成。家道清吉。可保安寧。";//東坡解一
		str6="凡事謀望。秋冬平平。春來運至。次第光亨。 遠行有信。所作皆成。家道清吉。可保安寧。";//東坡解二
		str7="";//碧仙註
		str8="凡事營求名以成。春來次第自通亨。 門庭吉利皆平善。財物相應漸漸生。";//碧仙註一
		str9="凡事營求久必成。春來次第自通亨。門庭吉利皆平善。財物相應漸漸成。"; //碧仙註二
		str10="此籤秋冬平平。逢春求財謀事。只宜漸進。不可急切。行人至。訟必理。病漸安。婚久成。凡謀事緩。則安康也。";//解曰
		str11="凡百謀望。秋終尋常。至春方可求名者。秋闈未遂。春闈及第。千里信音。宜遠不宜近。宜緩不宜急也。若躁進有害。萱堂母氏也。快樂無恙也。大抵此籤言家眷有慶餘。須看時令。合則吉。乖(乖本作乘)便非。";//釋義
		str12="一生占秋闈不中。應秋冬只尋常也。若占春闈則有可望。又晉江。鄭姓。倘弟戍杭城陷。眾皆謂。死其母患之。占此。不數日可往者。有人逃歸。始知尚在越年季春。乃以計脫。方回家。全詩俱驗";//占驗
		str13="(一)蘇卿負信\n漢。蘇武字。子卿。使匈奴。被留十九年。有一番女奉待甚殷。子卿納之。與生三子。歸時約其再往。迨到中國。後不克踐約。二子奉母命。來請蘇卿。置而不顧。番女所由責其有節而無信焉。盜謂聚猩猩之女非也。";//故事	
	}
	@Override
