...
public class Page_65Activity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第六五籤");
		text2.setText("【 上上。庚戊】");
		text4.setText("朔風凜凜正窮冬");
		text5.setText("漸覺門庭喜氣濃");
		text6.setText("更入新春人事後");
		text7.setText("衷言方得信先容");
		text8.setText("(一)蒙正木蘭和詩");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "朔風凜凜正窮冬漸覺門庭喜氣濃更入新春人事後衷言方得信先容"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20065%E7%B1%A4.jpg" ;//圖
		
		str1="財多得。名高中。可問婚。亦宜訟。 病即安。行人動。禍變消。福力重。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="數極于冬。窮久則通。交季冬月。喜氣重重。 新春一至。和氣愈充。好遇貴客。百事皆同。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="不意反成得意歸。入門一卦見仙機。 當時險難皆平靜。百事和諧沒是非。";//碧仙註一
		str9="失意反成得意歸。入門一卦見仙機。 當時險難皆平靜。百事和諧沒是非。"; //碧仙註二
		str10="此籤數極于窮冬。遇變而通。貴人提拔。百事亨通。病者安。訟宜和。財有望。婚可求。名利高。行人來。凡事死中求生也。";//解曰
		str11="言氣數之窮。有變亨之兆。時值冬月。雖多喜事。不若新春。人事之後。方始遂意。謂加以人為之周旋也。衷言者。貴人之言也。信先容者。凡事至春。凶變為吉。好事重重。";//釋義
		str12="一生科舉。占此。臨試給冬字號簽。至春發案不取。所謂窮冬者。此也。後遺才收錄。此又更入之。應窺則通之意。";//占驗
		str13="(一)蒙正木蘭和詩\n宋。呂蒙正。字聖初。河南人。微時嘗在僧家別院。木蘭寺內和詩。其品迥異庸流。迨太宗時。果舉進士第一。後三居相位。引薦人材。使上下各稱其職。稱賢相焉。";//故事	
	}
	@Override
