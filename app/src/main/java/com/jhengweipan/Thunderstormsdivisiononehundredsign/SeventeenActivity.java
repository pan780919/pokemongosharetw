...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第十七籤");
		text2.setText("【 下下。乙庚】");
		text4.setText("田園價貫好商量");
		text5.setText("事到公庭彼此傷");
		text6.setText("縱使機關圖得勝");
		text7.setText("定為後世子孫殃");
		text8.setText("(一)石崇被難");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "田園價貫好商量事到公庭彼此傷縱使機關圖得勝定為後世子孫殃"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20017%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="事悖理。訟必傷。名利未。亦如常。行人阻。病宜禳。且謹慎。保安康。";//聖意一
		str3="事悖理。訟必傷。名未濟。財平常。產勿謀。病宜禳。且謹慎。保安康。";//聖意二
		str4="";//東坡解
		str5="事依本分。自有前程。若用機關。反害其身。 如作交易。當合人情。倘或妄作。難保安寧。";//東坡解一
		str6="事依本分。自有前程。若用機關。反害其身。如作交易。當合人情。若見妄作。難保安寧。";//東坡解二
		str7="";//碧仙註
		str8="交加二字必虛勤。若問財時必見侵。凡事只宜退一步。須知守己得安寧。";//碧仙註一
		str9="心田兩字在公平。財產交關勿見侵。凡事只宜退一步。須知守己得安寧。"; //碧仙註二
		str10="此籤切須依本分。自有前程。如有機關。反成害己利人。 凡謀望。自家商酌方好。名利未遂。宜守平常。 行人有阻。病可禳。婚難成。謹保安康。";//解曰
		str11="此言訟不成。凡事循理而行。不願乎外。自得亨利。 子孫殃者。本身無事。家口多難。 占此。謀望。參商。功名阻滯。 切宜自安本分。莫置度外。恐有彼此是非。";//釋義
		str12="一人卜米價。是年米不貴。 又桐城內一士人。有螟蛉子。弗受駕馭。 一日偶督責之。竟自逃去。莫知所之。其父百計圖謀。 終無影響。迨占此之後。乃於勝果舖。尋得帶回家裏。 旋染怪病。破費許多。未蜀冠而殀亡。三四兩之驗如此。";//占驗
		str13="石崇被難（同觀音一百籤第六十四籤『石崇被害』）\n晉。石崇字季倫。為城陰太守。伐吳有功。封安陽鄉侯。財業豊積。室宇宏麗。庖膳窮水陸之珍。與王愷以奢靡相尚。後為交趾採訪。此有美女。名綠珠。以珍珠十斛買之。藏於金谷。被趙王倫窺見。乃以計害崇。冀得綠珠。及崇被難。綠珠墜樓而死。";//故事	
	}
	@Override
