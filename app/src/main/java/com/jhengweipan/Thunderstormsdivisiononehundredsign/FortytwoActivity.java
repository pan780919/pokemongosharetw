...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第四二籤");
		text2.setText("【中吉。戊乙】");
		text4.setText("我曾許汝事和諧");
		text5.setText("誰料修為果自乖懷");
		text6.setText("但改新圖莫依舊");
		text7.setText("營謀應得稱心");
		text8.setText("(一)董永賣身");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "我曾許汝事和諧誰料修為果自乖但改新圖莫依舊營謀應得稱心懷"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20042%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="病更醫。訟改圖。名與利。換規模。婚別議。行人遲。謹修為。神力持。";//聖意一
		str3="病更醫。訟改圖。名與利。換規模。婚別議。行人遲。神力助。謹修為";//聖意二
		str4="";//東坡解
		str5="神許和合。自乖所為。急須更變。方得其宜。心行正直。無好自欺。若能悔過。天必相之。";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="只好從新莫依舊。自然百事稱心神。莫愁中路無成就。當遇舟航涉利津。";//碧仙註一
		str9="改舊從新別有因。莫乖行止拂天神。管教中路多成就。穩趁舟航涉利津 。"; //碧仙註二
		str10="此籤宜更改。問婚當有再合之意。訟宜和。利吉。孕生男。求利改圖方好。病更醫。功名未遂。凡事更改方稱意。";//解曰
		str11="凡事只當遷改。不可蹈襲故常。積弊至蟲。名利未遂。若因改圖。庶幾提攜。有人向之。自乖者今得寧矣。營謀或作榮華未妥。";//釋義
		str12="一生久困。科場不利。占此遂改武學。後奉旨文料。中武生。一人此生竟聯捷。成文進士。應改圖而遇。仍獲所求也。";//占驗
		str13="(一)董永賣身\n漢。董永。千乘人。少失母。獨養父。流寓孝感。父亡無以葬。乃從人貸錢一萬。日後無錢還。當以身作奴。葬畢。道遇一婦人。求為永妻。永與俱詰。錢主令織縑三百疋以償。一月而畢。辭永去。乃曰。我(係)天上織女。緣君至孝。玉帝令我助君償債。言訖。凌空而去。";//故事	
	}
	@Override
