...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第十六籤");
		text2.setText("【 下下。乙己】");
		text4.setText("官事悠悠難辨明");
		text5.setText("不如息了且歸耕");
		text6.setText("旁人煽惑君休信");
		text7.setText("此事當謀親弟兄");
		text8.setText("王祥臥冰（與本籤較無關聯，驗證者仍可參考）");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "官事悠悠難辨明不如息了且歸耕旁人煽惑君休信此事當謀親弟兄"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20016%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="訟難明。和為貴。名利無。行人至。婚未成。病有祟。財莫貪。終無利。";//聖意一
		str3="訟難明。和為貴。功名無。行人至。婚未成。病有祟。財莫貪。終無利。";//聖意二
		str4="訟事未決。且宜從和。傍人煽惑。平地風波。 慎勿輕信。自投網羅。謀之兄弟。誰能奈何。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="埋頭莫向前。時違休怨天。 貴人垂手援。亨通到百年。";//碧仙註一
		str9="埋頭莫向前。時違休怨天。貴人垂手接。亨通到百年。"; //碧仙註二
		str10="此籤訟事未辨。以和為貴。名利全無。婚姻未當。 凡有謀望。且待時來。有人煽惑。勿輕信也";//解曰
		str11="問訟顯然宜和。士人占之。功名未遂。 官員占之。主難進步。有礙前程。 蓋明有神非。幽有鬼責。財利難求。營謀寡效。 凡事待時。不宜聽信讒人。萋菲之說。 兄弟謂至親之人。當謀之以決疑惑也。";//釋義
		str12="一監生科舉。卜此。見遺。後其弟新授。例到監。偕弟同懇人司成。得以續取。此事當謀。句驗甚。";//占驗
		str13="王祥臥冰（與本籤較無關聯，驗證者仍可參考）\n晉。王祥字伏徵。臨沂人。性至孝。事繼母極恭。謹母欲食生魚。天寒冰凍。祥赤身臥於冰上。求之。其冰立解。得雙鯉。持歸。人以為孝感云。後官至太保。進公爵。";//故事	
	}
	@Override
