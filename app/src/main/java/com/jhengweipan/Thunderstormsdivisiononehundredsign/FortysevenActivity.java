...
public class FortysevenActivity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第四七籤");
		text2.setText("【 下下(中平)。戊庚】");
		text4.setText("與君萬語復千言");
		text5.setText("祗欲平和雪爾冤");
		text6.setText("訟則終凶君記取");
		text7.setText("試於清夜把心捫");
		text8.setText("(一)楚漢爭鋒");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "與君萬語復千言祗欲平和雪爾冤訟則終凶君記取試於清夜把心捫"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20047%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="訟莫興。恐遭刑。財莫貪。病未寧。 行有阻。婚難成。且循理。保和平。";//聖意一
		str3="訟則終凶。不必多說。若得和平。舊冤可雪。 凡所謀望。皆當謹節。反求諸己。禍端自滅。";//聖意二
		str4="訟則終凶。不可多說。若得和平。舊冤可雪。 凡所謀望。皆當謹節。反求諸己。禍端自滅。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="心地好時身自吉。何須巧計去纘天。 勸君靜處勤修省。禍及身來不可損。";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤不可妄意。切莫貪求。但要和平。冤自可雪。謀事有反覆。婚難成。久而後成。財莫貪。疾未安。訟必凶。若有害人之意。反成殃也。";//解曰
		str11="戒人不可興訟。訟則終凶。不可成也。若能自處和平。則禍端自絕。冤抑可雪。占者凡事不可貪取。晝之所為。有一毫不善。清夜間。鬼神森列。雖不以為禍。而禍自生矣。(豈)不戒哉。";//釋義
		str12="一富人累為少年無賴所騙。不下百金。欲往訟之。占得此籤。乃清夜捫心。昔未富時。曾得一人數十金未償。其人卒無後。記其死之日。即此人生之時也。乃驚悟。再與少年十餘金。約有死者兩倍之數目。此不復生端矣。";//占驗
		str13="楚漢爭鋒\n項籍既滅秦。宰割天下。自立為西楚霸王。封沛公為漢王。陰弒義帝於江南。漢王乃拜韓信將。舉兵伐楚。定三秦。取咸陽。為義帝發喪。責楚弒逆之罪。與楚戰於成皋榮陽間。大戰三十。小戰七十。爭鋒五年。迨英布降漢。范增貶死。楚乃勢孤。被漢所滅。";//故事	
	}
	@Override
