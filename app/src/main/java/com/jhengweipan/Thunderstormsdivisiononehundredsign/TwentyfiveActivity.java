...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二五籤");
		text2.setText("【 中平。丙戊 】");
		text4.setText("寅午戍年多阻滯");
		text5.setText("亥子丑月漸亨嘉");
		text6.setText("待逢玉兔金雞會");
		text7.setText("枯木逢春自放花");
		text8.setText("(一)唐明皇遊月宮");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "寅午戍年多阻滯亥子丑月漸亨嘉待逢玉兔金雞會枯木逢春自放花"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20025%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="訟多憂。終則息。名利遲。婚姻吉。孕欲保。作福力。問行人。歸有日。";//聖意一
		str3="訟多憂。終則息。名利達。婚姻吉。孕欲保。作福力。問行人。歸有日。";//聖意二
		str4="";//東坡解
		str5="春夏秋時。作事遲疑。直至三冬。百事咸宜。 卯酉月日。降福孔皆。待此謀望。枯木開花。";//東坡解一
		str6="春夏秋時。作事遲疑。直至三冬。百事亨通。卯酉月日。所謀則吉。待此時來。枯木花開。";//東坡解二
		str7="";//碧仙註
		str8="謀事難成未可誇。枯木逢春始放花。 敗了又成離又聚。不宜共事與陰家。";//碧仙註一
		str9="謀事難成未可誇。枯木逢春始放花。敗了又成離又聚。及時雨露發光華。"; //碧仙註二
		str10="此籤作事遲疑。至三冬乃通。卯酉日月作事得時。如枯木開花。謀望各事。不勞心力而成。以寅午戍三者為凶。亥子丑年月日為吉。若謀事決。宜審時。不得妄動。訟終息。名利遲。婚姻吉。行人歸也。";//解曰
		str11="十二支干。凡寅午戍。人事有阻。不可進取。反是有禍。遇亥子丑。漸見亨嘉。至卯酉大吉。名成利就。取青紫如拾芥。凡事先看年月。以詳命運。正合亥子丑卯酉等字。遂意矣。君子得之。主仕(途)進。小人得之。逢恩赦至。";//釋義
		str12="一人久病。占得此籤。夏日請醫。來遲。問何以遲。曰看日食間。何為日食。對曰。日月交會也。病人大悟。籤語曰。吾病必痊矣。一劑而癒。";//占驗
		str13="(一)唐明皇遊月宮\n唐玄宗與方士羅光遠。八月十五日。秋宴。光遠取桂枝杖向空擲之。化為大橋。色如銀輿。帝同登遊。入月宮。見有霓裳羽衣之女歌唱。調甚新奇。帝默記其譜。以教大真。";//故事	
	}
	@Override
