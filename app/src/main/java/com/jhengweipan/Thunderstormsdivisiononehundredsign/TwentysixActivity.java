...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二六籤");
		text2.setText("【 中吉。丙己】");
		text4.setText("年來豐歉皆天數");
		text5.setText("祇是今年旱較多");
		text6.setText("與子定期三日內");
		text7.setText("田疇霑足雨滂沱");
		text8.setText("(一)邵堯夫告天");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "年來豐歉皆天數祇是今年旱較多與子定期三日內田疇霑足雨滂沱"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20026%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="名與利。今雖損。若遇時。便返本。 訟可解。病得安。婚即合。行人還。";//聖意一
		str3="";//聖意二
		str4="";//東坡解
		str5="吉凶天數。目下多迍。直待時至。如木逢春。 禱求皆應。定在三辰。謀望必遂。奸事相因。";//東坡解一
		str6="吉凶天數。目下多迍。直待時至。如木逢春。 禱求皆應。定在三辰。謀望必遂。好事臨門。";//東坡解二
		str7="";//碧仙註
		str8="吉凶天數奈如何。且待時來福氣和。 祈禱定應三日內。營為好事入門多。";//碧仙註一
		str9="吉凶天數竟如何。且待時來福氣和。 祈禱定應三日內。營為好事入門多。"; //碧仙註二
		str10="此籤謀事先損後遂。問病。星運未順。目下多悔方吉。病遇庚申日安。訟即解。名利難。行人三日內必至。婚未成。求財無。凡事不利達也。";//解曰
		str11="富貴皆有天數。非人力所為。凡百謀為。厄於時勢尚未順利。定期三日內。言後必有變也。庚者事之變。前庚三日為丁。後庚三日為癸。二字則變凶為吉。名成利就。又當謹修。於始不可妄動。病宜祈禱。子有三胎。大底(抵)虛名而少實也。";//釋義
		str12="一生。秋闈占此。三場連日皆雨。竟得中榜。應末兩句也。又一生屢試不利。晚年與其子仝考。出場後甚得意。命其子代占。得此益喜。有為斷日決。應抽者次句。自是兩字。已說明其父不信。親到占。復得此斷者。弗辯。榜發。其子取進。方悟初次。果應自是兩字。迨親身往占。乃示以與子定三字。";//占驗
		str13="邵堯夫告天\n宋。邵雍。字堯夫。范陽人。於書無所不讀。精天文易數。程子稱為振古之豪傑。遇若焚香告天。為民祈雨。竭盡誠敬。經王拱辰呂誨等。屢薦不起。卒年六十七。贈秘書省。著作郎元祐中。諡康節。";//故事	
	}
	@Override
