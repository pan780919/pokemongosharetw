...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第三七籤");
		text2.setText("【 中平(中吉)。丁庚】");
		text4.setText("焚香來告復何辭");
		text5.setText("善惡平分汝自知");
		text6.setText("屏卻昧公心裏事");
		text7.setText("出門無礙是通時");
		text8.setText("(一)邵堯夫祝香");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "焚香來告復何辭善惡平分汝自知屏卻昧公心裏事出門無礙是通時"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20037%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="訟和吉。病禱安。求財少。問名難。 婚可合。行人遣。宜向善。保團欒。";//聖意一
		str3="訟和吉。病禱安。名雋望。財頗難。婚可合。行人遣。宜向善。保團圓。";//聖意二
		str4="作善降祥。作惡降殃。何必禱神。當自揣量。 公心莫昧。勉為善良。前程遠大。可保安康。 ";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="爾欲陷人而自陷。欺心暗裡鬼神知。 若能改善求天福。轉禍為祥事事宜。";//碧仙註一
		str9="計欲陷人終自陷。欺心暗裡鬼神知。 若能改善求天福。轉禍為祥事事宜。"; //碧仙註二
		str10="此籤顯然說。主人家人有害人之心。而又受人之害。若能悔過則吉。訟宜和。病祈福。求財少。名利難。婚可合。只要心正。無事不吉也。";//解曰
		str11="人之為善為惡。人雖不知。己所獨知。若使欺其不知。而欲害之。不惟不能害人。抑反為人防害。不可不戒。占者當公平正大。不可暗昧欺人。則凡事亨通。而無阻滯。大抵此籤戒人為惡。勉人為善也。";//釋義
		str12="一人公門不利。占此。乃棄夫為商。大獲厚利。應在三四句。又晉江鄭生。將赴院試。占此後。果入泮。末句驗甚。";//占驗
		str13="(一)邵堯夫祝香\n宋。邵雍。字堯夫。年三十。從父徒居河南。於書無所不讀。精易理天文術數。居慎。凡所祝香。皆為國為親之事。未嘗私禱及己也。初除試。將作監主簿不起。繼除穎州團練推官不就。卒贈秘書省。著作郎元祐問。諡康節。";//故事	
	}
	@Override
