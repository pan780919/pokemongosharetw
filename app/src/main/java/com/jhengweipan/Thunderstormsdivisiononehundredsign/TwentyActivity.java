...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二十籤");
		text2.setText("【 下下。乙癸】");
		text4.setText("一生心事向誰論");
		text5.setText("十八灘頭說與君");
		text6.setText("世事盡從流水去");
		text7.setText("功名富貴等浮雲");
		text8.setText("(一)嚴子陵登釣臺");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "一生心事向誰論十八灘頭說與君世事盡從流水去功名富貴等浮雲"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20020%E7%B1%A4.jpg" ;//圖
		
		str1="訟終凶。止則宜。名利輕。病擇醫。 行人遠。婚遲疑。凡作事。且隨時";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="";//東坡解
		str5="凡事未決。且宜緩圖。時勢縱吉。未有神扶。凡事退省。終保無虞。更加修福。可履亨圖。";//東坡解一
		str6="心事未決。且宜緩圖。時勢縱吉。須仗神扶。凡事退省。終保無虞。更加修福。可履亨圖。";//東坡解二
		str7="";//碧仙註
		str8="險人求險地。說話險心腸。 有人牢把作。凶事得安康。";//碧仙註一
		str9="扁舟逢險地。傾覆善須防。 有人牢把作。凶事得安康。"; //碧仙註二
		str10="此籤得之外履。程途險阻。終不大吉利。 訟終凶。止則吉。功名輕。行人遲。婚未成。凡事到底不吉。宜謹守可也。";//解曰
		str11="始雖履險地。阻中多反覆。心事向誰論者。嘆不得逢貴人之焉。十八灘屬贛州灘名。惶恐難也。占此。主大事已去。有包羞忍恥之累。但當修省。功名富貴。雖得機會。終亦難就。切勿妄想。(得本作朔)只宜謹守。凡事。照占者審之。病不可保。孕不可得。";//釋義
		str12="一人買僕。占此後。僕逃去。應世從流水一句。又光緒間。安溪縣。一生歲試。 占此後。惟草索取錄十八名。此係第二句之應也。又晉江蘇。郭姓問二子。執得入泮。占此俱失意。 此乃第四句等浮雲之驗焉。";//占驗
		str13="嚴子陵登釣臺\n漢。嚴光字子陵。餘姚人。少有高名。與大武同遊學。 及光武即位。遂變姓名。隱身不仕。帝令物母訪之。 後齊國書云。有一男子。裘釣墨(墨左本有水)中。 帝疑為光。遭使聘之。三反乃至。除諫議大夫不屈。耕富春山。 帝遂其志。為建釣臺。東漢高士稱第一焉。";//故事	
	}
	@Override
