...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二七籤");
		text2.setText("【 下下(中平)。丙庚】");
		text4.setText("世間萬物各有主");
		text5.setText("一粒一毫君莫取");
		text6.setText("英雄豪傑自天生");
		text7.setText("也須步步循規矩");
		text8.setText("(一)江東得道");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "世間萬物各有主一粒一毫君莫取英雄豪傑自天生也須步步循規矩"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20027%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="訟莫興。病審醫。名與利。聽天推。 婚未定。行人遲。凡作事。安分宜。";//聖意一
		str3="訟莫興。審醫病。名與利。付之命。 行人遲。婚未定。凡百事。且安分。";//聖意二
		str4="";//東坡解
		str5="富貴分定。切莫強求。若或妄取。必有後憂。 且宜守舊。更勉進修。心行平等。自獲天佑。";//東坡解一
		str6="富貴分定。切莫強求。若或妄取。必有後憂。且宜守舊。更務進修。心行平等。自獲天庥。";//東坡解二
		str7="守分方可遇。欺凌必反災。 妄為難自保。依理福田來。 ";//碧仙註
		str8="";//碧仙註一
		str9=""; //碧仙註二
		str10="此籤只宜守分。不可妄為。若要謀事。不可以強凌弱。以富壓貧。稍涉欺凌。反成災害。訟必和。名利有。財難求。行人有阻。病宜禳方可。婚不宜也。";//解曰
		str11="名利近。不可得遠大。難(成)就。言萬物各有所主。戒占者不可以強凌弱。且富貴貧賤。自有分定。若妄為損其德行。安望名利之遠大哉。此籤大抵。當循規矩。自獲大祐。病者弗藥而自癒也。";//釋義
		str12="江東神廟。有大樹一株。明太祖皇帝欲伐之。初占此籤。猶為偶然。復占仍得此籤。遂驚嘆以為神異而置之。又一新科舉人。占得此。春闈大捷。應步步二字。若問一科者不利。又余族人。王生歲試。占此。入場東廊號舍。與江生隔鄰為道。題解得竅。果入泮。又一生。占此亦入泮。蓋上三句。未明示。主取生三個字。至結句六字。復暗藏一員字之議。王錢謹識。";//占驗
		str13="(一)江東得道\n錢塘。羅隱。號江東。唐末舉進士。求官不遂。立意修真。幸遇異人。傳授心法。因而得道。故能開口成讖。(讖本作織)嘗遊泉州。乞食於羅裳山下。鄉人慢之。江東畫馬於石。每夜出踐田穀。鄉人知而請罪焉。乃畫椿樹以繫馬。遂不踐。至今遺跡猶存。";//故事	
	}
	@Override
