...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第二三籤");
		text2.setText("【 下下。丙丙】");
		text4.setText("花開花謝在春風");
		text5.setText("貴賤窮通百歲中");
		text6.setText("羨子榮華今已矣");
		text7.setText("到頭萬事總成空");
		text8.setText("(一)吳王愛西施");
		text9.setText("(二)殷浩書空");
		
		
	}
	private void showString(){
		speakString = "花開花謝在春風貴賤窮通百歲中羨子榮華今已矣到頭萬事總成空"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20023%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="名與利。似虛花。訟解散。病益加。 婚未合。行人賒。事無就。徒咨嗟。";//聖意一
		str3="名與利。似虛花。訟解散。病愈加。 婚未合。行人賒。事無就。徒咨嗟。";//聖意二
		str4="";//東坡解
		str5="凡百謀望。有成有敗。始雖快意。終實成害。 吉中有凶。否生於泰。若不歛藏。後憂方大。";//東坡解一
		str6="凡百謀望。有成有敗。始雖快意。終竟成害。 吉中有凶。否生於泰。若不歛藏。後憂方大。";//東坡解二
		str7="";//碧仙註
		str8="此籤大不中。花開遇烈風。 不利老人占。病訟盡皆凶。";//碧仙註一
		str9="此籤大不終。花開遇暴風。榮華全剝落。病訟盡皆凶。"; //碧仙註二
		str10="此籤求望有成有敗。初快意。終有害。吉中有凶。否有泰。不善歛藏。後憂更大。名利虐。訟宜散。病防老人為凶。婚未成。行人遲。失物之憂。大不吉也。";//解曰
		str11="富貴窮通。四者循環。得失不久。如花之開落無時也。今已矣者。言凡事泰必復否。否必復泰。乃數之極。變之始也。但占者不為泰所移。不為否所困。斯為人定亦能勝天。病防老者。路防失財。婚防有別。孕必生女。";//釋義
		str12="一生未遇時。占此自謂。無發達之日。後入場坐空字號。遂得中榜。應在總成空之句。聖詩微妙。人不易測。";//占驗
		str13="(一)吳王愛西施\n吳既滅越。越王勾踐。卑詞請成。臥薪嘗膽。果報會稽之仇。與大夫范蠡。文種謀。乃選民間絕色西施女。進之吳王。夫差甚嬖愛之。至於亡國。";//故事	
	}
	@Override
