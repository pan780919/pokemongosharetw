...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第十八籤");
		text2.setText("【 中平。乙辛】");
		text4.setText("知君指擬是空華");
		text5.setText("底事茫茫未有涯");
		text6.setText("牢把腳根踏實地");
		text7.setText("善為善應永無差");
		text8.setText("(一)孟嘗君招賢");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "知君指擬是空華底事茫茫未有涯牢把腳根踏實地善為善應永無差"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20018%E7%B1%A4.jpg" ;//圖
		
		str1="";//聖意		
		str2="名利難。終則有。病禱神。訟勿鬥。 行人遲。事難就。且向善。祈福佑。";//聖意一
		str3="名利難。終則有。病禱神。訟勿問。 行人遲。事難就。且向善。祈福佑。";//聖意二
		str4="作事未成。空自指擬。且宜緩圖。急則損己。更宜向善。禱神求安。轉禍為福。可免多端。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="本分兩字到處諧。虧為妄想便生災。財源未遂徒勞力。且宜向善保亨來。";//碧仙註一
		str9="本分安常到處諧。虧為妄想便生災。 財源未遂徒勞力。且宜向善保亨來。"; //碧仙註二
		str10="此籤不宜妄意求謀。無事空自指擬。定必有損。切宜向善。祈禱神靈。轉禍成福。事有多般。功名無。訟勿鬥。行人遲。財難就。向善保安。乃為上策。";//解曰
		str11="空華謂事無成也。未有涯亦空也。凡事宜緩。不宜妄動。 求名利者。難得易失。若從善事行去。則是腳踏實地。無失處。 善為善應。言天之報施。並無差謬。 如遇禍患。占此能修省向善。自然轉凶為吉。而天必佑之矣。";//釋義
		str12="一道人遇寇。欲趨避。占此。潛隱草廬中。得脫去。是應腳根一句。 又一人被訟。占此。有司公出。不得歸結。是應底事一句。 又一生。占此。秋闈不中。是應第二句";//占驗
		str13="(一)孟嘗君招賢\n戰國。孟嘗君。姓田名文嘗。 謂其父田嬰。曰家累萬金。門下不見一覽者。後其父卒。 孟嘗君立在落(路)。招致諸侯賓客。及亡人。有罪者。皆歸焉。 孟嘗君舍業。厚遇之。以故傾天下之士。 其時。門下食客數千。無分貴賤。一與交等。";//故事	
	}
	@Override
