...
public class Page_72Activity extends Activity {
...
//		TextView text3 = (TextView)findViewById(R.id.textView3);
		...
		text1.setText("第七二籤");
		text2.setText("【 下下(中平)。辛乙】");
		text4.setText("河渠傍路有高低");
		text5.setText("可歎長途日已西");
		text6.setText("縱有榮華好時節");
		text7.setText("直須猴犬換金雞");
		text8.setText("(一)范蠡歸湖");
		text9.setText("");
		
		
	}
	private void showString(){
		speakString = "河渠傍路有高低可歎長途日已西縱有榮華好時節直須猴犬換金雞"; //郎誦文字
		photoStr = "http://www.chance.org.tw/%E7%B1%A4%E8%A9%A9%E9%9B%86/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E4%B8%80%E7%99%BE%E7%B1%A4/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%E6%8E%83%E6%8F%8F%E6%AA%94/%E9%9B%B7%E9%9B%A8%E5%B8%AB%E3%84%A7%E7%99%BE%E7%B1%A4%20-%20072%E7%B1%A4.jpg" ;//圖
		
		str1="求財遲。占病險。名難成。信尚遠。 訟終凶。婚必晚。孕必驚。地未穩。";//聖意		
		str2="";//聖意一
		str3="";//聖意二
		str4="修路崎嶇。況當衰晚。求事多難。徒自嗟嘆。 逢申酉戍。年月日見。若遇此時。稍可如願。";//東坡解
		str5="";//東坡解一
		str6="";//東坡解二
		str7="";//碧仙註
		str8="平川靜處被風傷。愛巧番成拙一場。 縱饒願得平川靜。只恐榮華不久長。";//碧仙註一
		str9="多少登場沒下場。平川靜處被風傷。眼前光景渾如夢。只恐榮華不久長。"; //碧仙註二
		str10="此籤干防有險阻。平地濃難。俗云。閉門家裏坐。禍從天上來。逢申酉戍年月日方吉。訟凶。財遲。功名難。婚姻晚。孕生必驚。病主險。事多凶也。";//解曰
		str11="主日平地涉險。凡事掣用。是乃命之所致。占此。不必嗟嘆。遇申戍年月日。頗得遂意。至酉上大得利。所謂崎嶇歷而通衢至也。";//釋義
		str12="一生宗師考試。占此獲二等科舉。發案得報消息。乃丙申日黃昏時榮華二語。應之不爽。";//占驗
		str13="(一)范蠡歸湖\n春秋。范蠡。字少伯。吳人。與文種同為我大夫。吳滅越。蠡與種。為越王勾踐畫策。卑詞請成。復求民間美女。得西施進於吳。迨滅吳。功成。蠡知勾踐可與同患難。不可共安樂。乃辭官。扁舟泛湖。止于陶。復以謀生致富。稱陶朱公。凡三徙。方成名。後不知所終。";//故事	
	}
	@Override
